...
const BookNow = () => {
  ...
  return (
    <section className="relative w-full h-full flex flex-col lg:flex-row justify-between items-center px-2 lg:px-10 py-28 bg-[url('assets/otherImg/treeBg.png')] bg-cover text-white">
      ...
      <div className="z-10 px-10 w-[100%] text-center lg:w-[600px] flex flex-col gap-10 justify-center items-center">
        <h1 className=" text-3xl lg:text-6xl text-[#F4BE23] font-bold">
      ...
      <div className="z-10 w-full lg:w-[600px] flex flex-wrap flex-row-reverse justify-center items-center">
        {images.map((img, idx) => (
          <img src={img} key={idx} className=" mt-10 w-32 lg:w-64 h-32 lg:h-64 hover:scale-105 duration-300" />
        ))}
      </div>
    </section>
  );
